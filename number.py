...
img = cv2.imread("Swift.jpeg") #read image
...
res = cv2.putText(img, text=text, org=(approx[0][0][0]-170, approx[1][0][1]+280), fontFace=font, fontScale=1.6, color=(0,255,0), thickness=4, lineType=cv2.LINE_AA) #put the text on the image
res = cv2.rectangle(img, tuple(approx[0][0]), tuple(approx[2][0]), (0,0,255),3) #Draw a rectangle around the text
